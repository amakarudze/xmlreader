...
@pytest.fixture
def file(db):
    return Upload.objects.create(file='google.comdjangogirls.org!1649808000!1649894399 2.xml')


@pytest.fixture
def file_data():
    fpath = os.path.join(settings.BASE_DIR, "xml_files/google.comdjangogirls.org16498080001649894399.xml")
